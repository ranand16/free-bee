  ...
  "text-sm text-subtle dark:text-subtle-old box-border px-space.075 py-space.100 border-input-border border-2 rounded hover:bg-text-input-hovered focus:bg-flag dark:bg-input dark:border-[#A6C5E229] dark:focus-within:border-[#85B8FF] dark:caret-[#ffffff] dark:text-[#ffffff] dark:hover:bg-input-hovered",
  {
    variants: {
      variant: {
        ...
        subtle:
          "text-sm text-subtle box-border px-space.075 py-space.100 border-[#091E4224] border-0 hover:border-2 focus-within:border-2 rounded hover:bg-text-input-hovered focus:bg-flag dark:bg-input dark:border-[#A6C5E229] dark:focus-within:border-[#85B8FF] dark:caret-[#ffffff] dark:text-[#ffffff] dark:hover:bg-input-hovered",
        transparent:
...
const InputField = forwardRef<HTMLInputElement, InputFieldProps>(
  (
    { label, helperMessage, className, variant, icon, iconPosition, ...props },
    ref
  ) => {
    return (
        ...
        <div className="inputfield-container">
          ...
          <div className="relative">
            <input
              ...
              className={cn(
                InputFieldVariants({ variant, className, iconPosition })
              )}
              {...props}
            ></input>
            {iconPosition == "start" ? (
